! function(t, e) {
    ...
    return e.prototype = {
        ...
        createDragZone: function() {
            var e, i;
            e = this.createEls("p", {}, "Drop an Image or Click Here"), i = this.createEls("input", {
                type: "file",
                multiple: "multiple",
                accept: "image/*"
        ...
        matchFiles: function(t, e) {
            ...
            } else i.classList.remove("bg-success"), i.classList.add("bg-danger"), i.innerHTML = "Invalid filetype(images only)"
        },
        upload: function(i) {
            var e, n, a, s;
